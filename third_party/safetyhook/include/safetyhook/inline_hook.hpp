...
#pragma GCC diagnostic pop
    ...
    [[nodiscard]] std::expected<void, Error> disable(std::span<const IpRange> extra_hazardous_ranges = {});

    [[nodiscard]] std::expected<void, Error> quiesce(std::span<const IpRange> extra_hazardous_ranges);
...
private:
    ...
    uint8_t* m_target{};
    uint8_t* m_patch_target{};
    uint8_t* m_destination{};
    Allocation m_trampoline{};
    std::vector<uint8_t> m_original_bytes{};
    std::vector<IpMapping> m_ip_mappings{};
    uintptr_t m_trampoline_size{};
    uintptr_t m_trampoline_code_size{};
    uint8_t* m_trampoline_return{};
    uint8_t* m_trampoline_destination{};
