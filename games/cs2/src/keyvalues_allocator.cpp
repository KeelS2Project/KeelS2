...
void operator delete(void* value) noexcept { if (value) MemAlloc_Free(value); }
...
void operator delete[](void* value, const std::nothrow_t&) noexcept { ::operator delete(value); }
void* operator new(std::size_t size, int, const char*, int) { return ::operator new(size); }
void* operator new[](std::size_t size, int, const char*, int) { return ::operator new(size); }
void operator delete(void* value, int, const char*, int) noexcept { ::operator delete(value); }
void operator delete[](void* value, int, const char*, int) noexcept { ::operator delete(value); }
