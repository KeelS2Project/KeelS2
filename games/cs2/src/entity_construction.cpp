    ...
    KeelCs2EntityConstructionBindings& bindings, std::string& error)
{
    ...
    {
        error = "entity construction are unavailable for this compatibility profile";
    ...
    {
        error = "entity construction server fingerprint changed";
    ...
    for (std::size_t i = 0; i < entries.size(); ++i) {
        ...
        {
            error = "entity construction address is outside the module";
            return KEEL_RESULT_INCOMPATIBLE;
        }
        ...
        for (std::size_t j = 0; j < entry.bytes.size(); ++j)
            ...
            {
                error = "entity construction code is not readable and executable";
                return KEEL_RESULT_INCOMPATIBLE;
            }
        ...
        {
            error = "entity construction code changed";
            return KEEL_RESULT_INCOMPATIBLE;
        }
    }
