...
static_assert(KEELS2_PAUSE_API_VERSION == 1);
static_assert(sizeof(KeelPauseApi) == 16);
static_assert(offsetof(KeelPauseApi, set_prepare_callback) == 8);
...
static_assert(KEELS2_PLAYER_INPUT_API_VERSION == 1);
static_assert(sizeof(KeelPlayerInput) == 24);
static_assert(offsetof(KeelPlayerInput, buttons) == 8);
static_assert(offsetof(KeelPlayerInput, context) == 16);
static_assert(sizeof(KeelPlayerInputApi) == 16);
static_assert(offsetof(KeelPlayerInputApi, read) == 8);
static_assert(std::is_standard_layout_v<KeelPlayerInput>);
