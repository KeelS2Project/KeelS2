...
{
public:
    static constexpr PluginInfo Info{"Docs Hook Returns", "KeelS2 documentation", "1.0.0", "Compare return override and supersede on an owned target"};
    bool Load() override
    {
...
private:
    ...
    {
        if (value == 0 && call.SetResult(100)) return PLUGIN_SUPERSEDE;
    ...
    Action After(HookCall<int>& call, int value)
    {
        ...
        if (value == 1 && call.SetResult(200)) return PLUGIN_OVERRIDE;
        return PLUGIN_CONTINUE;
    }
