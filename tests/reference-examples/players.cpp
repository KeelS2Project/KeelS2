...
public:
    static constexpr PluginInfo Info{
        "Docs Players", "KeelS2 documentation", "1.0.0", "Player lookup, iteration and connection identity"};

    bool Load() override
    {
        return CreateCommand("keel_docs_players",
                             "List players and remember the caller",
                             &Players::List,
                             FCVAR_GAMEDLL | FCVAR_CLIENT_CAN_EXECUTE) &&
               CreateCommand("keel_docs_remembered",
                             "Look up the remembered connection",
                             &Players::Remembered,
                             FCVAR_GAMEDLL | FCVAR_CLIENT_CAN_EXECUTE);
    }
