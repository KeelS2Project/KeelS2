...
{
public:
    static constexpr PluginInfo Info{"Docs Hook Arguments", "KeelS2 documentation", "1.0.0", "Change an argument to a plugin-owned virtual call"};
    bool Load() override
    {
...
private:
    Action Before(int& value) { value += 3; return PLUGIN_CONTINUE; }
