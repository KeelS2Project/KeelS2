...
EXPECTED = {
    ...
    "adapter": {"KeelGameAdapter_Query", "KeelGameAdapter_CommandCaller", "KeelGameAdapter_PlayerAction", "KeelGameAdapter_QueryPlayers", "KeelGameAdapter_QueryMessaging", "KeelGameAdapter_QueryConVarObservers"},
