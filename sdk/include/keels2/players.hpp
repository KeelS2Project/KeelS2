...
enum class PlayerButton : uint64
{
    Forward = KEELS2_BUTTON_FORWARD, Back = KEELS2_BUTTON_BACK,
    Left = KEELS2_BUTTON_LEFT, Right = KEELS2_BUTTON_RIGHT,
    Use = KEELS2_BUTTON_USE, Reload = KEELS2_BUTTON_RELOAD,
    Jump = KEELS2_BUTTON_JUMP, Duck = KEELS2_BUTTON_DUCK,
    Attack = KEELS2_BUTTON_ATTACK, Attack2 = KEELS2_BUTTON_ATTACK2,
    Walk = KEELS2_BUTTON_WALK, Score = KEELS2_BUTTON_SCORE,
    Zoom = KEELS2_BUTTON_ZOOM, Inspect = KEELS2_BUTTON_INSPECT,
    UseOrReload = KEELS2_BUTTON_USE_OR_RELOAD
};
