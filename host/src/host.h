...
struct PluginRecord
{
    ...
    KeelPreparePauseCallback prepare_pause{};
    void* prepare_pause_data{};
    bool prepare_pause_active{};
    KeelPrepareUnloadCallback prepare_unload{};
    void* prepare_unload_data{};
    bool prepare_unload_active{};
...
private:
    ...
    void ShowPluginConVars(const PluginRecord* plugin);
    ...
    std::vector<std::unique_ptr<PluginRecord>> disabled_plugins_;
